...
#    Updated: 2022/02/07 21:06:40 by guhernan         ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
clang++ -Wall -Werror -Wextra -Wshadow -fsanitize=address -g3 main.cpp VectorTester.hpp ITester.hpp IteratorVector.hpp ReverseIteratorVector.hpp  IteratorTraits.hpp &&  ./a.out \
